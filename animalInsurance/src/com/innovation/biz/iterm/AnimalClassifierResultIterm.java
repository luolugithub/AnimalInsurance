...
import com.innovation.biz.classifier.CattleRotationAndKeypointsClassifier;
...
//cattle keypoint and rotation model
...
//
//            if (DetectorActivity.type1Count < maxLeft && CattleRotationAndKeypointsClassifier.cattleRotationAndKeypointsK1 == true) {
//
//                DetectorActivity.AngleTrackType = 1;
//                DetectorActivity.type1Count++;
//                LOGGER.i("type1数量:" + DetectorActivity.type1Count);
...
//                        DetectorActivity.type2Count, DetectorActivity.type3Count);
//
//            }else if ( DetectorActivity.type2Count < maxMiddle && CattleRotationAndKeypointsClassifier.cattleRotationAndKeypointsK2 == true){
//                DetectorActivity.AngleTrackType = 2;
//                DetectorActivity.type2Count++;
//                LOGGER.i("type2数量:" + DetectorActivity.type2Count);
//                FileUtils.saveInfoToTxtFile(txtfilename, contenType + "angle:" + type);
...
//                DetectorActivity.tracker.getCountOfCurrentImage(DetectorActivity.type1Count,
//                        DetectorActivity.type2Count, DetectorActivity.type3Count);
//            } else if (DetectorActivity.type3Count < maxRight && CattleRotationAndKeypointsClassifier.cattleRotationAndKeypointsK3 == true) {
//                DetectorActivity.AngleTrackType = 3;
//                DetectorActivity.type3Count++;
//                LOGGER.i("type3数量:" + DetectorActivity.type3Count);
//                FileUtils.saveInfoToTxtFile(txtfilename, contenType + "angle:" + type);
...
//    }
    ...
    public static int cowAngleCalculateTFlite(PostureItem postureItem) {
        ...
        if (DetectorActivity.type1Count < maxLeft && (CowRotationClassifier.cowRotationPredictSuccessR1 == true
...
//            FileUtils.saveBitmapToFile(postureItem.srcBitmap, tmpImageSrcFileName);//保存src图片
        ...
        }else if ( DetectorActivity.type2Count < maxMiddle && (CowRotationClassifier.cowRotationPredictSuccessR2 == true
...
//            FileUtils.saveBitmapToFile(postureItem.srcBitmap, tmpImageSrcFileName);//保存src图片
            ...
            DetectorActivity.tracker.getCountOfCurrentImage(DetectorActivity.type1Count,
                    DetectorActivity.type2Count, DetectorActivity.type3Count);
        } else if (DetectorActivity.type3Count < maxRight && (CowRotationClassifier.cowRotationPredictSuccessR3 == true
