...
public class DonkeyRotationAndKeypointsClassifier implements Classifier {
    ...
    public PredictRotationIterm donkeyRotationAndKeypointsClassifier(Bitmap bitmap) {
        ...
        if (donkeyPredictAngleType == 1 && pointsExists[6] + pointsExists[7] +pointsExists[8]+ pointsExists[9]+ pointsExists[10] == 5
            ...
            com.innovation.utils.ImageUtils.saveBitmap(padBitmap,"donkeyRotP1",DonkeyFaceBoxDetector.srcDonkeyBitmapName);
            ...
            com.innovation.utils.ImageUtils.saveBitmap(padBitmap,"donkeyRotP2",DonkeyFaceBoxDetector.srcDonkeyBitmapName);
            ...
            com.innovation.utils.ImageUtils.saveBitmap(padBitmap,"donkeyRotP3",DonkeyFaceBoxDetector.srcDonkeyBitmapName);
        }else {
            // draw rotation
            com.innovation.utils.ImageUtils.drawText(canvasDrawRecognition,
                    "角度:"+donkeyPredictAngleType,10,30,
                    ...
                    "Y:"+String.valueOf(predictRotY * rotScale),10,90);
            com.innovation.utils.ImageUtils.drawKeypoints(canvasDrawRecognition,points,padSize);
            com.innovation.utils.ImageUtils.saveBitmap(padBitmap,"donkeyRotOther",DonkeyFaceBoxDetector.srcDonkeyBitmapName);
        }
