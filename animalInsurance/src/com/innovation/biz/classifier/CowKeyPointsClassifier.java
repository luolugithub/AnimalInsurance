...
public class CowKeyPointsClassifier implements Classifier {
    ...
    public List<PointFloat> recognizePointImage(Bitmap bitmap) {
        ...
        sLogger.i("CowKeyPointsClassifier cost:" + (SystemClock.uptimeMillis() - startTime));
        ...
        sLogger.i("获取的关键点 %d:" + pointFloats.toString());
        // TODO: 2018/11/20 By:LuoLu  理赔角度修改测试
        Canvas canvasDrawPoints = new Canvas(padBitmap);
        if (GlobalConfigure.model == 1){
            if (pointsExists[11] + pointsExists[12] == 2
                ...
                com.innovation.utils.ImageUtils.drawKeypoints(canvasDrawPoints, pointFloats,padSize);
