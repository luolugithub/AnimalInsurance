...
public class CowRotationClassifier implements Classifier {
    ...
    public static boolean cowRotationPredictSuccessR1;
    public static boolean cowRotationPredictSuccessR2;
    public static boolean cowRotationPredictSuccessR3;
    ...
    public PredictRotationIterm cowRotationAndKeypointsClassifier(Bitmap bitmap) {
        ...
        cowRotationPredictSuccessR1 = false;
        cowRotationPredictSuccessR2 = false;
        cowRotationPredictSuccessR3 = false;
        ...
        if (cowPredictAngleType == 1){
            ...
            cowRotationPredictSuccessR1 = true;
            ...
            cowRotationPredictSuccessR2 = true;
            ...
            cowRotationPredictSuccessR3 = true;
        }else {
            // draw rotation
            Canvas canvasDrawRecognition = new Canvas(padBitmap);
            com.innovation.utils.ImageUtils.drawText(canvasDrawRecognition,
